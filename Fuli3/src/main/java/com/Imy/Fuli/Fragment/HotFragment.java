...
public class HotFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = View.inflate(UiUtils.getContext(), R.layout.hot_viewpager_item, null);
        mIndicator = Constant.MY_INDICATOR;
        mListView = (MultiColumnListView) view.findViewById(R.id.hot_viewpage_listview);
    ...
    private void initData() {
        ...
        for (int i = 0; i < Constant.url2.length; i++) {
            String title = TITLE[i];
            String icon = Constant.url2[i];
