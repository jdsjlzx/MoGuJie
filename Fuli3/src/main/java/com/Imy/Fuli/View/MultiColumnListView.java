...
import com.Imy.Fuli.lib.ParcelableSparseIntArray;
import com.Imy.Fuli.lib.internal.PLA_AbsListView;
import com.Imy.Fuli.lib.internal.PLA_ListView;
...
public class MultiColumnListView extends PLA_ListView {
	...
	private HorizontalListView mSupLayout = Constant.MY_INDICATOR;
		...
		switch (ev.getAction()) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (deltaY > 0) {
                    ...
                    LogUtils.w("Indicator.getVisibility()"+mSupLayout.getVisibility());
                    if (mSupLayout.getVisibility() ==GONE){ //特殊滑动状态
